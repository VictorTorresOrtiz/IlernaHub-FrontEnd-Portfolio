        ...
        <div class="row">
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <!-- ***** Menu Start ***** -->
                    <ul class="nav">
                        <li><a href="../../IlernaHub-FrontEnd-Portfolio/IlernaHub-Frontend(CON PHP)/index.php">Home</a></li>
                        <li><a href="../../IlernaHub-FrontEnd-Portfolio/IlernaHub-Frontend(CON PHP)/team.php">Friends</a></li>
            ...
            <div class="col-lg-12">
              <div class="main-profile ">
                <div class="row">
                  ...
                  <div class="col-lg-4 align-self-center">
                    <ul>
                      <li>Account Settings <a href="../../IlernaHub-FrontEnd-Portfolio/IlernaHub-Frontend(CON PHP)/UserManagement/login.php"><span><i class="fa fa-spin fa-gear"></i></span></li></a>
                      <li>Friends Online <a href="#"><span><i class="fa fa-user-group"></i></span></li></a>                     
                      <li>Notifications <a href="#"><span><i class="fa fa-bell"></i></span></li></a>
                    </ul>
                  </div>
                </div> 
